...
import { usePilotAgent } from "@/hooks/use-pilot-agent"
...
export function PilotBuilder() {
  ...
  const { isCreating, error: creationError, progress, createAgent, agentId } = usePilotAgent()
  ...
  // Success View - Non-editable summary
  if (showSuccessView && agentId) {
    return (
      <div className="w-full">
        <Card className="p-6 lg:p-8 bg-gradient-to-br from-green-500/5 via-background to-background border-green-500/20">
          <div className="max-w-3xl mx-auto space-y-6">
            ...
            <div className="text-center space-y-4">
              ...
              <div>
                <h3 className="text-2xl font-bold">Agent Created Successfully!</h3>
            ...
            <div className="p-4 rounded-lg bg-primary/5 border border-primary/20">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-primary">Redirecting to your agent...</p>
