...
export function APIConnections() {
  ...
  return (
    <section ref={ref} className="py-32 px-4 bg-background relative overflow-hidden">
      <div className="absolute inset-0 bg-[linear-gradient(to_right,rgb(var(--border))_1px,transparent_1px),linear-gradient(to_bottom,rgb(var(--border))_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_at_center,black_50%,transparent_100%)] opacity-[0.08]" />
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_50%,rgba(var(--primary),0.08),transparent)]" />
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="relative flex h-[500px] w-full flex-col items-center justify-center overflow-hidden">
          {/* Center logo */}
          <div className="relative z-10 flex h-20 w-20 items-center justify-center rounded-full border-2 bg-white dark:bg-slate-900 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]">
            <img src="/logo.png" alt="Ryu Logo" className="w-18 h-18 object-contain" />
          </div>
        ...
        <div className="mt-16 text-center">
          <p className="text-sm text-muted-foreground mb-8 font-medium">{t('moreComing')}</p>
          <div className="flex flex-wrap justify-center gap-3">
            {["Airtable", "Google Sheets", "Slack", "Discord", "GitHub", "Linear"].map((name) => (
              <div
                key={name}
                className="px-5 py-2.5 rounded-lg border border-border/50 bg-card/50 backdrop-blur-sm text-xs font-semibold text-muted-foreground hover:border-border hover:bg-card transition-all"
              >
                {name}
              </div>
            ))}
...
const Icons = {
  ...
  zapier: () => (
    <svg width="105" height="28" viewBox="0 0 244 66" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path
        d="M169.515 0.00366253C168.666 -0.0252113 167.820 0.116874 167.027 0.421484C166.234 0.726094 165.511 1.187 164.899 1.77682C164.297 2.3723 163.824 3.08658 163.512 3.87431C163.2 4.66204 163.055 5.50601 163.086 6.35275C163.056 7.20497 163.201 8.05433 163.514 8.84781C163.826 9.64129 164.299 10.3619 164.902 10.9646C165.505 11.5673 166.226 12.0392 167.020 12.3509C167.814 12.6626 168.663 12.8074 169.515 12.7762C170.362 12.8082 171.206 12.6635 171.994 12.3514C172.782 12.0392 173.496 11.5664 174.091 10.963C174.682 10.3534 175.142 9.63077 175.446 8.83849C175.75 8.04621 175.89 7.20067 175.859 6.35275C175.898 5.50985 175.761 4.66806 175.456 3.88115C175.151 3.09424 174.686 2.37951 174.090 1.78258C173.493 1.18565 172.779 0.719644 171.992 0.414327C171.206 0.109011 170.364 -0.0288946 169.521 0.00938803L169.515 0.00366253Z"
        fill="#201515"
      />
      <path
  ...
  messenger: () => (
    <svg width="100" height="100" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
      <radialGradient id="8O3wK6b5ASW2Wn6hRCB5xa" cx="11.087" cy="7.022" r="47.612" gradientUnits="userSpaceOnUse">
