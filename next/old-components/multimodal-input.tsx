      ...
      >
        ...
        <div className="flex flex-row gap-1 items-start sm:gap-2">
          <PromptInputTextarea
            ...
            ref={textareaRef}
            placeholder={status === 'streaming' ? "Generating response..." : "Send a message..."}
            value={input}
